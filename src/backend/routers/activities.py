...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level (e.g., 'Beginner', 'Intermediate', 'Advanced', or 'all' for no difficulty)
    """
    ...
    if difficulty:
        if difficulty == "all":
            # "all" means activities with no difficulty specified (No Difficulty filter)
